...
namespace Brainamics.Core
{
    ...
    internal sealed class PriorityQueueDebugView<TElement, TPriority>
    {
        ...
        {
            ArgumentNullExceptionUtils.ThrowIfNull(queue);
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            ArgumentNullExceptionUtils.ThrowIfNull(items);
        ...
        {
            ArgumentNullExceptionUtils.ThrowIfNull(elements);
                                                       ...
                                                       ICollection
        {
            ...
            {
                ArgumentNullExceptionUtils.ThrowIfNull(array);
